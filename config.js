...
module.exports = {
  ...
  DBX_APP_KEY: process.env.DBX_APP_KEY || config.parsed.DBX_APP_KEY,
  DBX_APP_SECRET: process.env.DBX_APP_SECRET || config.parsed.DBX_APP_SECRET,
  OAUTH_REDIRECT_URL:
    process.env.OAUTH_REDIRECT_URL || 'http://localhost:3000/oauthredirect',
